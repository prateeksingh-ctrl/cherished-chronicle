...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gold-gradient': 'linear-gradient(135deg, hsl(41 60% 42%) 0%, hsl(45 75% 60%) 50%, hsl(41 60% 42%) 100%)',
        'crimson-gradient': 'radial-gradient(ellipse at center, hsl(0 100% 24%) 0%, hsl(0 100% 12%) 100%)',
      },
    },
  },
