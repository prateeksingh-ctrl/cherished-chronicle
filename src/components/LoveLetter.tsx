      ...
      >
        ...
        <div className="font-serif text-lg md:text-xl leading-[2.2] text-gray-700 text-justify">
          <p className="mb-8">
            ...
            f life is a magazine, you are the cover story. This year has been a collection of moments that I want to archive forever. Not just the big wins or the explorations, but the quiet Sundays and the soulful talks.
          </p>
          <p className="mb-8">
            I don't know what 2026 holds, but as long as you are in the byline, I know it will be a bestseller. Thank you for being my sunshine, my partner, and my best friend.
          </p>
          <p>
